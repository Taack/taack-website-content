...
* *Java* (JDK 25 ...)
* *Git*
* https://github.com/unoconv/unoserver[unoserver]
...
.Install JDK 25 and Git using Winget
[source,bash]
----
...
.Credentials
image::first-app-1-credentials.webp[Reload,width=520,align="left"]
...
Make sure that Gradle is using JDK 25:

.Open Gradle Settings and Check Gradle JDK Version
image:install-java25-gradle-select.webp[]

<1> Open Gradle Settings
<2> Check Gradle JVM version is 25 (The provider can be anything)
