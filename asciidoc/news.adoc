...
* SolrSearch changes, now you can register how an object is supposed to be shown (See <<TaackGormClassRegisterService>>)
...
image::screenshot-contextual-menu-on-field.webp[]
