...
* Grails 7.2.3
* New `taack-ui-ext` maven artifact to add graphical components
* <<calendar-component>>
...
----
<1> Create table from `TaackCalendarEvent` iterator. Using Adapter pattern to convert any object to `TaackCalendarEvent`.

image::news-calendar-table-view.webp[]
...
----
image::news-calendar-regular-view.webp[]
...
[[save-or-close-and-refresh]]
.New Save Or close modal and refresh
====
.Code
[source,groovy]
----
...
* xref:doc/DSLs/diagram-dsl.adoc[Diagram DSL] :
...
* Grails 7.0.7, Java 25 for Runtime and Building
* <<kan-ban>>
* <<table-inline-edit>>
...
.Kan-Ban
image::screenshot-kanban.webp[]


====

[[table-inline-edit]]
.Edit Objects in Table
====
...
image::screenshot-scrollpanel.webp[]
