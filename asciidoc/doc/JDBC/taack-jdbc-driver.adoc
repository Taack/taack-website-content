= Taack JDBC Driver
:doctype: book
:taack-category: 0|doc/JDBC
:toc:
:source-highlighter: rouge
// ifdef::webimagesdir[:imagesdir: {webimagesdir}]
...
group Querying Object using TQL
        ...
        Driver -> Intranet : Tranmit the Query
...
The main difference with a regular JDBC Driver and our is the Query language.
