...
.myBooks Content
image::first-app-4-content-app.webp[Reload,width=520,align="left"]
...
.Create a class
image::first-app-5-create-class.webp[Reload,width=520,align="left"]
...
.Empty Books Table
image::first-app-7-creating-table.webp[Reload,width=1000,align="left"]
...
.Button
image::first-app-8-adding-button.webp[Reload,width=1000,align="left"]
...
.Form
image::first-app-10-creating-form.webp[Reload,width=800,align="left"]

.Books saved
image::first-app-11-adding-book.webp[Reload,width=800,align="left"]
...
.Showing object
image::first-app-13-view-books.webp[Reload,width=800,align="left"]
...
.Filtering
image::first-app-20-using-filter.webp[Reload,width=800,align="left"]
...
.Author Table
image::first-app-23-authors-filled.webp[Reload,width=800,align="left"]
...
image::first-app-24-book-form-with-author-class.webp[Reload,width=800,align="left"]

.Selecting the author (click on the blue button)
image::first-app-25-book-from-ajaxfield.webp[Reload,width=800,align="left"]
...
.Database connector not flushing transaction :
